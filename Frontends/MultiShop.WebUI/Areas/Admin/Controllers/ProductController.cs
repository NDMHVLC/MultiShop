...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
	...
	public class ProductController : Controller
	{
		...
		public async Task<IActionResult> CreateProduct()
		{
			ViewBag.v0 = " Ürünler Sayfası";
			ViewBag.v1 = " Ana Sayfa";
			ViewBag.v2 = " Ürün Ekleme Sayfası";
			ViewBag.v3 = " Ürünü İşlemleri";
		...
		{
			ViewBag.v0 = " Ürün Güncelleme Sayfası";
			ViewBag.v1 = " Ana Sayfa";
			ViewBag.v2 = " Ürün Güncelleme Sayfası";
			ViewBag.v3 = " Ürünü İşlemleri";
			...
			List<SelectListItem> categories1 = (from x in values1
											   select new SelectListItem
											   {
												   Text = x.CategoryName,
												   Value = x.CategoryID
											   }).ToList();
			ViewBag.CategoryValues1 = categories1;
